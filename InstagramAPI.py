...
class InstagramAPI:
    ...
    #username            # conormcclung
    #password            # Conor4674413
    #debug               # Debug
    #uuid                # UUID
    #device_id           # Device ID
    ...
    def __init__(self, conormcclung
                , Conor4674413, debug = False, IGDataPath = None):
        m = hashlib.md5()
        m.update(username.encode('utf-8') + password.encode('utf-8'))
        self.device_id = self.generateDeviceId(m.hexdigest())
        self.setUser(conormcclung, Conor4674413)
